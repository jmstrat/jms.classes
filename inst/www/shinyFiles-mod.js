// shinyFiles.js from shinyFiles R package
// Modifications - J. Stratford Nov 2017:
// Added Shiny.onInputChange($(button).attr('id')+'-state',......
// 
// Shiny.bindAll; //Modified all occurances to only bind button
// Shiny.unbindAll; //Modified all occurances to only bind button
...
var shinyFiles = (function() {
	...
	var compareArrays = function (arrayA, arrayB) {
        /*
        Modified from TomÃ¡Å¡ Zatos answer at http://stackoverflow.com/questions/7837456/comparing-two-arrays-in-javascript
        */
    ...
    Shiny.onInputChange($(button).attr('id')+'-state', 'closed');
		Shiny.unbindAll(button);
	...
	sF.init = function() {
      ...
      Shiny.onInputChange($(this).attr('id')+'-state', 'open');
		}).on('click', function(e) {
